...
const ascii = __nccwpck_require__(3665)
...
if (isNodeEOL(process.version)) {
  ...
  if (false) {} else {
    module.exports = {
      isNodeVulnerable: (__nccwpck_require__(3675).isNodeVulnerable)
    }
  }
}
...
const { danger, allGood, bold, vulnerableWarning, separator } = __nccwpck_require__(3665)
const { request } = __nccwpck_require__(5687)
const fs = __nccwpck_require__(7147)
...
const { isNodeVulnerable } = __nccwpck_require__(4351)
